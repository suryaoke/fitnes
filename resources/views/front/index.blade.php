...
@section('title')
    Olahraga Bareng Fitcamp
@endsection

@section('content')
    <header class="relative flex flex-col w-full h-[1044px] overflow-hidden -mb-[140px]">
        <img src="{{ asset('fitnes/assets/images/backgrounds/Header Illustration.svg') }}"
        ...
        <div id="hero-text" class="relative flex flex-col items-center mx-auto mt-[96px]">
            <div class="flex items-center w-fit rounded-[38px] p-2 pr-6 gap-3 bg-fitcamp-black">
                <img src="{{ asset('fitnes/assets/images/photos/triple-photo.png') }}" class="flex shrink-0 w-[88px] h-10"
                    alt="photos">
    ...
    <section id="features" class="relative w-full max-w-[1280px] h-[280px] mx-auto px-10">
        <div
            ...
            <div class="flex flex-col items-center w-[282px] gap-4 text-center">
                <img src="{{ asset('fitnes/assets/images/icons/Located.svg') }}" class="w-[72px] h-[72px] flex shrink-0"
                    alt="icon">
            ...
            <div class="flex flex-col items-center w-[282px] gap-4 text-center">
                <img src="{{ asset('fitnes/assets/images/icons/coupon-dollar.svg') }}"
                    class="w-[72px] h-[72px] flex shrink-0" alt="icon">
            ...
            <div class="flex flex-col items-center w-[282px] gap-4 text-center">
                <img src="{{ asset('fitnes/assets/images/icons/Muscle.svg') }}" class="w-[72px] h-[72px] flex shrink-0"
                    alt="icon">
                ...
                <a href="{{ route('front.details', $itemNewGym->slug) }}" class="card">
                    <div class="flex flex-col rounded-3xl p-8 gap-6 bg-white">
                        ...
                        <div class="grid grid-cols-3 justify-between gap-3">
                            @forelse ($itemNewGym->gymFacilities as $itemFacility)
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <p class="text-xs leading-14 tracking-05 opacity-50">
                                    {{ $itemNewGym->open_time_at->format('h:i A') }} -
                                    {{ $itemNewGym->closed_time_at->format('h:i A') }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 w-fit">
                            <div class="w-16 h-16 rounded-full overflow-hidden">
                                <img src="{{ asset('fitnes/assets/images/photos/image-1.png') }}"
                                    class="w-full h-full object-cover" alt="photos">
                            </div>
                            <div class="flex flex-col gap-2">
                                <p class="font-['ClashDisplay-SemiBold'] text-2xl leading-[29.52px] tracking-05">Tatang
                                    Sutarman</p>
                ...
                <div class="swiper-slide w-full">
                    <div
                        ...
                        <div class="flex items-center gap-3 w-fit">
                            <div class="w-16 h-16 rounded-full overflow-hidden">
                                <img src="{{ asset('fitnes/assets/images/photos/image-2.png') }}"
                                    class="w-full h-full object-cover" alt="photos">
                            </div>
                            <div class="flex flex-col gap-2">
                                <p class="font-['ClashDisplay-SemiBold'] text-2xl leading-[29.52px] tracking-05">Tatang
                ...
                <div class="swiper-slide w-full">
                    <div
                        ...
                        <div class="flex items-center gap-3 w-fit">
                            <div class="w-16 h-16 rounded-full overflow-hidden">
                                <img src="{{ asset('fitnes/assets/images/photos/image-3.png') }}"
                                    class="w-full h-full object-cover" alt="photos">
                            </div>
                            <div class="flex flex-col gap-2">
                                <p class="font-['ClashDisplay-SemiBold'] text-2xl leading-[29.52px] tracking-05">Tatang
    ...
    <section id="benefits" class="flex flex-col w-full max-w-[1280px] gap-8 mx-auto px-10 mt-[120px]">
        ...
        <div class="w-[1060px] mx-auto grid grid-cols-3 gap-20 mt-20">
            <div class="flex flex-col items-center text-center gap-4">
                <img src="{{ asset('fitnes/assets/images/icons/Flexible Time.svg') }}" class="w-[120px] h-[120px]"
                    alt="icon">
            ...
            <div class="flex flex-col items-center text-center gap-4">
                <img src="{{ asset('fitnes/assets/images/icons/Work From Anywhere.svg') }}" class="w-[120px] h-[120px]"
                    alt="icon">
            ...
            <div class="flex flex-col items-center text-center gap-4">
                <img src="{{ asset('fitnes/assets/images/icons/Expert Trainer.svg') }}" class="w-[120px] h-[120px]"
                    alt="icon">
            ...
            <div class="flex flex-col items-center text-center gap-4">
                <img src="{{ asset('fitnes/assets/images/icons/Schedule.svg') }}" class="w-[120px] h-[120px]"
                    alt="icon">
            ...
            <div class="flex flex-col items-center text-center gap-4">
                <img src="{{ asset('fitnes/assets/images/icons/Event.svg') }}" class="w-[120px] h-[120px]"
                    alt="icon">
            ...
            <div class="flex flex-col items-center text-center gap-4">
                <img src="{{ asset('fitnes/assets/images/icons/Enjoy.svg') }}" class="w-[120px] h-[120px]"
                    alt="icon">
...
@push('after-scripts')
    ...
    <script src="{{ asset('fitnes/js/index.js') }}"></script>
@endpush
