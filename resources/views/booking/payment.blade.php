...
@section('content')
    ...
    <form action="{{ route('front.payment_store') }}" id="content" method="POST" enctype="multipart/form-data"
            ...
            <div id="booking-items" class="flex flex-col w-full rounded-3xl p-8 gap-6 bg-white">
                <div class="flex flex-col gap-2">
                    <p class="font-['ClashDisplay-SemiBold'] text-xl leading-6 tracking-05">Booking ID : <span
                            class="text-[#606DE5]">TBD</span></p>
                </div>
                <div class="items flex flex-nowrap gap-4 w-full">
                    <img src="{{ asset('fitnes/assets/images/icons/cart.png') }}" class="w-10 h-10 flex shrink-0"
                        alt="icon">
                ...
                <div class="group flex items-center justify-between">
                    ...
                    <p class="leading-19 tracking-05"> {{ number_format($subscribePackage->price, 0, ',', '.') }}</p>
                </div>
                <div class="group flex items-center justify-between">
                    <p class="flex w-[162px] shrink-0 font-['ClashDisplay-SemiBold'] leading-19 tracking-05">PPN 11%</p>
                    <p class="leading-19 tracking-05"> {{ number_format($booking['total_ppn'], 0, ',', '.') }}</p>
                </div>
                <div class="group flex items-center justify-between">
        ...
        <div class="flex flex-col gap-6 w-full">
            <div class="flex flex-col w-full rounded-3xl p-8 gap-6 bg-white">
                ...
                <div class="flex items-center gap-4">
                    <img src="{{ asset('fitnes/assets/images/logos/BCA.png') }}" class="w-12 flex shrink-0" alt="logo">
                    <div class="flex flex-col gap-2">
                ...
                <div class="flex items-center gap-4">
                    <img src="{{ asset('fitnes/assets/images/logos/MANDIRI.png') }}" class="w-12 flex shrink-0"
                        alt="logo">
                    <div class="flex flex-col gap-2">
                        <p class="font-['ClashDisplay-SemiBold'] leading-19 tracking-05">Fitnesia Corporation</p>
                        <p class="leading-19">129405960495</p>
    ...
    <footer class="flex flex-col w-full max-w-[1312px] mx-auto rounded-[32px] bg-black p-[120px] mt-[120px] mb-16">
        <div class="flex justify-between">
            <div class="flex flex-col gap-6 max-w-[306px] text-start">
                <img src="{{ asset('fitnes/assets/images/logos/Logo-2.png') }}" class="h-12 w-fit" alt="icon">
...
@push('after-scripts')
    <script src="{{ asset('fitnes/js/file-input.js') }}"></script>
@endpush
